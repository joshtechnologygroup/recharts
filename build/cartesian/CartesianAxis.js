...
var CartesianAxis = (function (_super) {
    ...
    CartesianAxis.getTicksStart = function (_a, preserveEnd) {
        ...
        var unitSize = unit && sizeKey === 'width' ? DOMUtils_1.getStringSize(unit, { fontSize: fontSize, letterSpacing: letterSpacing })[sizeKey] : 0;
        ...
        if (preserveEnd) {
            ...
            var tailSize = DOMUtils_1.getStringSize(tailContent, { fontSize: fontSize, letterSpacing: letterSpacing })[sizeKey] + unitSize;
        ...
        for (var i = 0; i < count; i++) {
            ...
            var size = DOMUtils_1.getStringSize(content, { fontSize: fontSize, letterSpacing: letterSpacing })[sizeKey] + unitSize;
            if (i === 0) {
