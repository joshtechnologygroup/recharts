...
function Surface(props) {
    ...
    return (react_1.default.createElement("svg", __assign({}, types_1.filterProps(others, true, true), { className: layerClass, width: width, height: height, style: style, viewBox: svgView.x + " " + svgView.y + " " + svgView.width + " " + svgView.height, version: "1.1" }),
