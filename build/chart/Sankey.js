    ...
    Sankey.getDerivedStateFromProps = function (nextProps, prevState) {
        ...
        if (data !== prevState.prevData ||
            ...
            return __assign(__assign({}, prevState), { nodes: nodes,
                links: links, prevData: data, prevWidth: iterations, prevHeight: height, prevMargin: margin, prevNodePadding: nodePadding, prevNodeWidth: nodeWidth, prevIterations: iterations });
        }
        return null;
    };
